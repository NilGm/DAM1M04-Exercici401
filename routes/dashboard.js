...
router.get('/', async (req, res) => {
    try {
        ...
        const [c_avui] = await db.query("SELECT COUNT(*) as t FROM sales WHERE DATE(sale_date) = CURDATE()");
        const [c_mes] = await db.query("SELECT COUNT(*) as t FROM sales WHERE MONTH(sale_date) = MONTH(CURDATE())");
